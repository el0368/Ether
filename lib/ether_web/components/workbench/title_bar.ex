defmodule EtherWeb.Components.Workbench.TitleBar do
  ...
  def title_bar(assigns) do
    ...
    <div
      ...
      class="h-[var(--vscode-titlebar-height)] min-h-[var(--vscode-titlebar-height)] bg-[var(--vscode-titlebar-activebackground)] flex items-center justify-between px-2 select-none border-b border-[#2b2b2b]"
    >
      <div class="flex items-center gap-4 h-full">
        <div class="flex items-center gap-2"><img src="/images/logo.png" class="w-5 h-5" /></div>
        ...
        <div data-tauri-no-drag class="flex items-center gap-1 h-full text-[13px]">
          ...
          <div phx-click="toggle_panel" class="px-2 py-1 hover:bg-[#505050] rounded cursor-pointer">
            Terminal
          </div>
      ...
      <div
        data-tauri-no-drag
        phx-update="ignore"
        class="flex items-center h-full text-[13px]"
        phx-hook="WindowControls"
        id="window-controls"
      >
        <div
          data-window-action="minimize"
          class="flex items-center justify-center w-[46px] h-full hover:bg-[#ffffff1a] cursor-pointer"
          title="Minimize"
        >
          <svg
            width="10"
        ...
        <div
          ...
          class="flex items-center justify-center w-[46px] h-full hover:bg-[#e81123] cursor-pointer group"
          title="Close"
        >
          <svg
            width="10"
