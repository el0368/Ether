import { c as createWebWorker, l as languages } from './app.js';
import { H as HoverAdapter, D as DocumentHighlightAdapter, h as DocumentLinkAdapter, F as FoldingRangeAdapter, b as DocumentSymbolAdapter, S as SelectionRangeAdapter, c as RenameAdapter, f as DocumentFormattingEditProvider, g as DocumentRangeFormattingEditProvider, C as CompletionAdapter } from './lspLanguageFeatures-CgteTtJF.js';
export { a as DefinitionAdapter, e as DiagnosticsAdapter, d as DocumentColorAdapter, R as ReferenceAdapter, i as fromPosition, j as fromRange, t as toRange, k as toTextEdit } from './lspLanguageFeatures-CgteTtJF.js';
  ...
  _getClient() {
    ...
    if (!this._client) {
      this._worker = createWebWorker({
        ...
        createWorker: () => new Worker(new URL(/* @vite-ignore */ "/assets/html.worker-WwUn8Vrh.js", import.meta.url), { type: "module" }),
...
//# sourceMappingURL=./htmlMode-agO02Bht-7f026d98790c09f82007ac39ba36469a.js.map
