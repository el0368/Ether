import { c as createWebWorker, e as editor, U as Uri, a as MarkerTag, M as MarkerSeverity, l as languages, t as typescriptDefaults, R as Range } from './app.js';
    ...
    if (!this._client) {
      this._client = (async () => {
        this._worker = createWebWorker({
          ...
          createWorker: () => new Worker(new URL(/* @vite-ignore */ "/assets/ts.worker-91m8zWDK.js", import.meta.url), { type: "module" }),
          label: this._modeId,
          keepIdleModels: true,
...
//# sourceMappingURL=./tsMode-v6TotLJy-1f58269260322453beffd2e35b7b1aa6.js.map
